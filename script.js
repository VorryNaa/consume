...
let songs = [

    {
        ...
        audioSrc: "https://files.catbox.moe/obrbyf.mp3",
    ...
    lyrics: [
      { time: 0.0, text: "Pain is never permanent, but tonight it's killing me" },
      { time: 4.0, text: "I hope you get your ballroom floor" },
      { time: 8.0, text: "Your perfect house with rose red doors" },
      { time: 12.0, text: "I'm the last thing you'd remember" },
      { time: 16.0, text: "It's been a long, lonely December" },
      { time: 20.0, text: "I wish I'd known that less is more" },
      { time: 24.0, text: "But I was passed out on the floor" },
      { time: 28.0, text: "And that's the last thing I remember" },
      { time: 32.0, text: "It's been a long, lonely December" }
    ]
  },
